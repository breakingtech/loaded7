        ...
        if ( $Qproduct->numberOfRows() === 1 ) {
          ...
          if ( !empty($this->_data) ) { 
            ...
            if ($this->_data['is_subproduct'] > 0) {
              $Qmaster = $lC_Database->query('select products_name as parent_name, products_blurb as blurb, products_description as description, products_keyword as keyword, products_tags as tags, products_url as url from :table_products_description where products_id = :products_id and language_id = :language_id limit 1');
              ...
              $desc['blurb'] = $Qmaster->value('blurb');
