...
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(182, 'Core Template Color Scheme', 'TEMPLATES_CORE_COLOR_SCHEME', 'charcoal', 'The Core Template Color Scheme?', '6', '0', now(), now(), 'lc_cfg_set_template_color_pulldown_menu', 'lc_cfg_set_template_color_pulldown_menu(array(''charcoal'', ''blue_lightning'', ''red_umber'', ''green_valley'', ''orange_summer'', ''yellow_highlight''))');
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(183, 'Loacalization Menu', 'TEMPLATES_CORE_HEADER_LOCALIZATION', '1', 'Display the localization menu in the header?', '6', '0', now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(184, 'Socail Icons', 'TEMPLATES_CORE_HEADER_SOCIAL', '1', 'Display the social icons in the header?', '6', '0', now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(185, 'Header Search', 'TEMPLATES_CORE_HEADER_SEARCH', '1', 'Display the searh field in the header?', '6', '0', now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(186, 'Product Blurb', 'TEMPLATES_CORE_LISTING_BLURB', '1', 'Display the blurb in the products listing?', '6', '0', now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(187, 'Featured Ribbon', 'TEMPLATES_CORE_LISTING_FEATURED_RIBBON', '1', 'Display the featured ribbon in the products listing?', '6', '0', now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(188, 'On Sale Ribbon', 'TEMPLATES_CORE_LISTING_SALE_RIBBON', '1', 'Display the sale ribbon in the products listing?', '6', '0', now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(189, 'New Product Ribbon', 'TEMPLATES_CORE_LISTING_NEW_RIBBON', '1', 'Display the new product ribbon in the products listing?', '6', '0', now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(190, 'Best Seller Ribbon', 'TEMPLATES_CORE_LISTING_BEST_RIBBON', '1', 'Display the best seller ribbon in the products listing?', '6', '0', now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(191, 'Highest Rating Ribbon', 'TEMPLATES_CORE_LISTING_RATING_RIBBON', '1', 'Display the highest rating ribbon in the products listing?', '6', '0', now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');
