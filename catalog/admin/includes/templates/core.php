...
class lC_Template_core {
  ...
  public function install() {
    ...
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('Core Template Color Scheme', 'TEMPLATES_CORE_COLOR_SCHEME', 'charcoal', 'The Core Template Color Scheme?', '6', '0', now(), now(), 'lc_cfg_set_template_color_pulldown_menu', 'lc_cfg_set_template_color_pulldown_menu(array(\'charcoal\',\'blue_lightning\',\'red_umber\',\'green_valley\',\'orange_summer\',\'yellow_highlight\'))')");
