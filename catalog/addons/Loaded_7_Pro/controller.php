...
if (file_exists(DIR_FS_CATALOG . 'includes/classes/transport.php')) require_once($lC_Vqmod->modCheck(DIR_FS_CATALOG . 'includes/classes/transport.php'));
...
class Loaded_7_Pro extends lC_Addon { // your addon must extend lC_Addon
  ...
  */
  public function Loaded_7_Pro() {    
    ...
    */     
    $this->_compatibility = '7.002.1.1'; // the addon is compatible with this core version and later   
   /**
