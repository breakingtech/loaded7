          ...
          <div class="row">
            ...
            <div class="col-sm-4 col-lg-4">
              <div class="well relative no-padding-bottom">
                ...
                <div class="btn-group clearfix absolute-top-right small-padding-top large-margin-right-neg">
                  <button type="button" onclick="window.location.href='<?php echo lc_href_link(FILENAME_CHECKOUT, 'shipping_address', 'SSL'); ?>';" class="btn white btn-xs" style="font-size:.7em;"><?php echo $lC_Language->get('button_edit'); ?></button>
                </div>
              </div>
              <div class="well relative clearfix small-padding-top small-padding-bottom"> 
                ...
                <div class="btn-group clearfix absolute-top-right large-margin-right-neg small-padding-top">
                  <button type="button" onclick="window.location.href='<?php echo lc_href_link(FILENAME_CHECKOUT, 'shipping', 'SSL'); ?>'" class="btn white btn-xs" style="font-size:.7em;"><?php echo $lC_Language->get('button_edit'); ?></button>
                </div>                  
              </div>   
              <div class="well relative no-padding-bottom">
                ...
                <div class="btn-group clearfix absolute-top-right large-margin-right-neg small-padding-top">
                  <button type="button" onclick="window.location.href='<?php echo lc_href_link(FILENAME_CHECKOUT, 'payment_address', 'SSL'); ?>';" class="btn white btn-xs" style="font-size:.7em;"><?php echo $lC_Language->get('button_edit'); ?></button>
                </div>
              </div>
              <div class="well relative clearfix small-padding-top small-padding-bottom"> 
                ...
                <div class="btn-group clearfix absolute-top-right small-padding-top large-margin-right-neg">
                  <button type="button" onclick="window.location.href='<?php echo lc_href_link(FILENAME_CHECKOUT, 'payment', 'SSL'); ?>';" class="btn white btn-xs" style="font-size:.7em;"><?php echo $lC_Language->get('button_edit'); ?></button>
                </div>                  
              </div>
              <div class="well relative clearfix small-padding-top small-padding-bottom"> 
